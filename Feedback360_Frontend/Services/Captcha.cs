...
namespace Feedback360_Frontend.Services
{
    public class Captcha
    {
        ...
        //private readonly CaptchaVM _captcha;
        public Captcha(IConfiguration configuration)
        {
            _configuration = configuration;
        }
        //const string letters = _captcha.CaptchaLetters;

        public static string GenerateCaptchaCode()
        {
            //string letters = _configuration.GetValue<string>("CaptchaString:CaptchaLetters");
            string letters = AppSettingsHelper.Setting("CaptchaString:CaptchaLetters");
