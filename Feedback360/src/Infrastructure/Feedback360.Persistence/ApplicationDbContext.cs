...
namespace Feedback360.Persistence
{
    ...
    public class ApplicationDbContext:DbContext
    {
        ...
        public DbSet<FeedbackAnswerForm> FeedbackForms { get; set; }
        public DbSet<UserAuthorityMapping> UserAuthorityMappings { get; set; }
        public DbSet<FeedbackUserMapping> FeedbackUserMappings { get; set; }
            ...
            foreach (var entry in ChangeTracker.Entries<AuditableEntity>())
            {
                switch (entry.State)
                {
                    case EntityState.Added:
                        ...
                        entry.Entity.CreatedBy = _loggedInUserService.UserRole;
                        break;
                    case EntityState.Modified:
                        entry.Entity.LastModifiedDate = DateTime.UtcNow;
                        entry.Entity.LastModifiedBy = _loggedInUserService.UserRole;
                        break;
                }
            }
